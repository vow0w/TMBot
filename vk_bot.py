...
class VkBot:
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "РАСПИСАНИЕ", "КОМАНДЫ", "ПОМОЩЬ", "ПОКА", "ДЗ", "ЗАМЕНЫ", "ACLEAR", "АНИМЕ", "СПИСОК"]
