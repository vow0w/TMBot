    ...
    if request.status_code == 200:
        ...
        for div in divs:
            ...
            if Str == "\n1) Тетрадь смерти\n2) Атака титанов\n3) Мастера меча онлайн\n4) Стальной алхимик\n5) Ванпанчмен\n6) Токийский Гуль\n7) Врата Штейна":
                return f'Такого имя пользователя не существует'
        return Str
...
class VkBot:
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "РАСПИСАНИЕ", "КОМАНДЫ", "ПОМОЩЬ", "ПОКА", "ДЗ", "ЗАМЕНЫ", "ACLEAR", "АНИМЕ", "СПИСОК", "ПРЕПОД"]
