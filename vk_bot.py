...
class VkBot:
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "РАСПИСАНИЕ", "КОМАНДЫ", "ПОМОЩЬ", "ПОКА", "АНИМЕ", "СПИСОК", "ПРЕПОД", "ACLEAR", "ДЗ", "ЗАМЕНЫ"]
